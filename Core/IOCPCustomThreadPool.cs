...
namespace Timok.Core {
	...
	//-- This is the type of user function to be supplied for the thread pool
	public delegate void DISPATCHER(uint iValue);

	//-- This class provides the ability to create a thread pool to manage work.  
	//-- The class abstracts the Win32 IOCompletionPort API so it requires the use of
