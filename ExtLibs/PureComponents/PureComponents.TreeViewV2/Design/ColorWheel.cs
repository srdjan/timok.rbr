...
{
	internal class ColorWheel : IDisposable
	{
		...
		internal ColorChangedEventHandler ColorChanged;
		...
		public void Draw(Graphics g, ColorManagerWheel.HSV HSV)
		{
		...
		private Color[] GetColors()
		{
			...
			for (int i = 0; i <= COLOR_COUNT - 1; i++)
				Colors[i] = ColorManagerWheel.HSVtoColor((int) ((double) (i * 255) / COLOR_COUNT), 255, 255);
			return Colors;
		}
