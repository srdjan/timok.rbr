// <fileinfo name="Base\BoxCollection_Base.cs">
//		<copyright>
...
{
	/// <summary>
	/// The base class for <see cref="BoxCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="BoxCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class BoxCollection_Base
	{
		// Constants
		public const string Box_idColumnName = "box_id";
		public const string Date_createdColumnName = "date_created";
		public const string Date_activatedColumnName = "date_activated";

		// Instance fields
		private Rbr_Db _db;

		/// <summary>
		/// Initializes a new instance of the <see cref="BoxCollection_Base"/> 
		/// class with the specified <see cref="Rbr_Db"/>.
		/// </summary>
		/// <param name="db">The <see cref="Rbr_Db"/> object.</param>
		public BoxCollection_Base(Rbr_Db db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>Box</c> table.
		/// </summary>
		/// <returns>An array of <see cref="BoxRow"/> objects.</returns>
		public virtual BoxRow[] GetAll()
		{
		...
		/// includes all records from the <c>Box</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>Box</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="BoxRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="BoxRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public BoxRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			BoxRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="BoxRow"/> objects that 
		...
		/// <returns>An array of <see cref="BoxRow"/> objects.</returns>
		public BoxRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="BoxRow"/> objects.</returns>
		public virtual BoxRow[] GetAsArray(string whereSql, string orderBySql,
		...
		/// <summary>
		/// Gets <see cref="BoxRow"/> by the primary key.
		/// </summary>
		/// <param name="box_id">The <c>box_id</c> column value.</param>
		/// <returns>An instance of <see cref="BoxRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual BoxRow GetByPrimaryKey(int box_id)
		{
			string whereSql = "[box_id]=" + _db.CreateSqlParameterName("Box_id");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "Box_id", box_id);
			BoxRow[] tempArray = MapRecords(cmd);
		...
		/// <summary>
		/// Updates the <c>Box</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>Box</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["Box_id"]);
						}
						finally
						{
							row.Delete();
		...
		/// <summary>
		/// Deletes a record from the <c>Box</c> table using
		/// the specified primary key.
		/// </summary>
		/// <param name="box_id">The <c>box_id</c> column value.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public virtual bool DeleteByPrimaryKey(int box_id)
		{
			string whereSql = "[box_id]=" + _db.CreateSqlParameterName("Box_id");
		...
		/// <summary>
		/// Deletes <c>Box</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>Box</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		{
			string sql = "DELETE FROM [dbo].[Box]";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>Box</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="BoxRow"/> objects.</returns>
		protected BoxRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="BoxRow"/> objects.</returns>
		protected BoxRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		protected virtual DataTable CreateDataTable()
		{
			...
			dataColumn.AllowDBNull = false;
			dataColumn = dataTable.Columns.Add("Date_activated", typeof(System.DateTime));
			dataColumn.Caption = "date_activated";
			return dataTable;
		}
	...
	} // End of BoxCollection_Base class
}  // End of namespace
