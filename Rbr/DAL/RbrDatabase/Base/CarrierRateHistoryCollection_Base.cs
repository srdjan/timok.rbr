// <fileinfo name="Base\CarrierRateHistoryCollection_Base.cs">
//		<copyright>
...
{
	/// <summary>
	/// The base class for <see cref="CarrierRateHistoryCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="CarrierRateHistoryCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CarrierRateHistoryCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CarrierRateHistoryCollection_Base"/> 
		/// class with the specified <see cref="Rbr_Db"/>.
		/// </summary>
		/// <param name="db">The <see cref="Rbr_Db"/> object.</param>
		public CarrierRateHistoryCollection_Base(Rbr_Db db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>CarrierRateHistory</c> table.
		/// </summary>
		/// <returns>An array of <see cref="CarrierRateHistoryRow"/> objects.</returns>
		public virtual CarrierRateHistoryRow[] GetAll()
		{
		...
		/// includes all records from the <c>CarrierRateHistory</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>CarrierRateHistory</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="CarrierRateHistoryRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="CarrierRateHistoryRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public CarrierRateHistoryRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			CarrierRateHistoryRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CarrierRateHistoryRow"/> objects that 
		...
		/// <returns>An array of <see cref="CarrierRateHistoryRow"/> objects.</returns>
		public CarrierRateHistoryRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="CarrierRateHistoryRow"/> objects.</returns>
		public virtual CarrierRateHistoryRow[] GetAsArray(string whereSql, string orderBySql,
		...
		{
			string sql = "SELECT * FROM [dbo].[CarrierRateHistory]";
		...
		/// <summary>
		/// Gets <see cref="CarrierRateHistoryRow"/> by the primary key.
		/// </summary>
		...
		/// <returns>An instance of <see cref="CarrierRateHistoryRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual CarrierRateHistoryRow GetByPrimaryKey(int carrier_route_id, System.DateTime date_on)
		{
			string whereSql = "[carrier_route_id]=" + _db.CreateSqlParameterName("Carrier_route_id") + " AND " +
			...
			CarrierRateHistoryRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CarrierRateHistoryRow"/> objects 
		/// by the <c>R_336</c> foreign key.
		/// </summary>
		/// <param name="carrier_route_id">The <c>carrier_route_id</c> column value.</param>
		/// <returns>An array of <see cref="CarrierRateHistoryRow"/> objects.</returns>
		public virtual CarrierRateHistoryRow[] GetByCarrier_route_id(int carrier_route_id)
		{
		...
		/// return records by the <c>R_336</c> foreign key.
		/// </summary>
		/// <param name="carrier_route_id">The <c>carrier_route_id</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="CarrierRateHistoryRow"/> objects 
		/// by the <c>R_337</c> foreign key.
		/// </summary>
		/// <param name="rate_info_id">The <c>rate_info_id</c> column value.</param>
		/// <returns>An array of <see cref="CarrierRateHistoryRow"/> objects.</returns>
		public virtual CarrierRateHistoryRow[] GetByRate_info_id(int rate_info_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>R_337</c> foreign key.
		/// </summary>
		/// <param name="rate_info_id">The <c>rate_info_id</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Updates the <c>CarrierRateHistory</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>CarrierRateHistory</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((int)row["Carrier_route_id"], (System.DateTime)row["Date_on"]);
						}
						finally
						{
							row.Delete();
		...
		/// <summary>
		/// Deletes a record from the <c>CarrierRateHistory</c> table using
		/// the specified primary key.
		/// </summary>
		/// <param name="carrier_route_id">The <c>carrier_route_id</c> column value.</param>
		/// <param name="date_on">The <c>date_on</c> column value.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public virtual bool DeleteByPrimaryKey(int carrier_route_id, System.DateTime date_on)
		{
			string whereSql = "[carrier_route_id]=" + _db.CreateSqlParameterName("Carrier_route_id") + " AND " +
							  "[date_on]=" + _db.CreateSqlParameterName("Date_on");
		...
		/// <summary>
		/// Deletes records from the <c>CarrierRateHistory</c> table using the 
		/// <c>R_336</c> foreign key.
		/// </summary>
		/// <param name="carrier_route_id">The <c>carrier_route_id</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>R_336</c> foreign key.
		/// </summary>
		/// <param name="carrier_route_id">The <c>carrier_route_id</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>R_337</c> foreign key.
		/// </summary>
		/// <param name="rate_info_id">The <c>rate_info_id</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes <c>CarrierRateHistory</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>CarrierRateHistory</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		{
			string sql = "DELETE FROM [dbo].[CarrierRateHistory]";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>CarrierRateHistory</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="CarrierRateHistoryRow"/> objects.</returns>
		protected CarrierRateHistoryRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="CarrierRateHistoryRow"/> objects.</returns>
		protected CarrierRateHistoryRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// the <c>CarrierRateHistory</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "CarrierRateHistory";
			DataColumn dataColumn;
	...
	} // End of CarrierRateHistoryCollection_Base class
}  // End of namespace
