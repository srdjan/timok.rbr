// <fileinfo name="Base\EndPointRow_Base.cs">
//		<copyright>
...
{
	/// <summary>
	/// The base class for <see cref="EndPointRow"/> that 
	/// represents a record in the <c>EndPoint</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="EndPointRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	[Serializable]
	public abstract class EndPointRow_Base
	{
	#region Timok Custom
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="EndPointRow_Base"/> class.
		/// </summary>
		public EndPointRow_Base()
		{
			// EMPTY
		}
