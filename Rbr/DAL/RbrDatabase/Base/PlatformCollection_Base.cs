// <fileinfo name="Base\PlatformCollection_Base.cs">
//		<copyright>
...
{
	/// <summary>
	/// The base class for <see cref="PlatformCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="PlatformCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PlatformCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PlatformCollection_Base"/> 
		/// class with the specified <see cref="Rbr_Db"/>.
		/// </summary>
		/// <param name="db">The <see cref="Rbr_Db"/> object.</param>
		public PlatformCollection_Base(Rbr_Db db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>Platform</c> table.
		/// </summary>
		/// <returns>An array of <see cref="PlatformRow"/> objects.</returns>
		public virtual PlatformRow[] GetAll()
		{
		...
		/// includes all records from the <c>Platform</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>Platform</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="PlatformRow"/> objects that 
		...
		public PlatformRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			PlatformRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="PlatformRow"/> objects that 
		...
		/// <returns>An array of <see cref="PlatformRow"/> objects.</returns>
		public PlatformRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="PlatformRow"/> objects.</returns>
		public virtual PlatformRow[] GetAsArray(string whereSql, string orderBySql,
		...
		/// <summary>
		/// Updates the <c>Platform</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>Platform</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
			...
			for(int i = rows.Count - 1; i >= 0; i--)
			{
				...
				switch(row.RowState)
				{
					...
					case DataRowState.Deleted:
						...
						try
						{
							DeleteByPrimaryKey((short)row["Platform_id"]);
						}
						finally
						{
							row.Delete();
		...
		/// <summary>
		/// Deletes a record from the <c>Platform</c> table using
		/// the specified primary key.
		/// </summary>
		/// <param name="platform_id">The <c>platform_id</c> column value.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public virtual bool DeleteByPrimaryKey(short platform_id)
		{
			string whereSql = "[platform_id]=" + _db.CreateSqlParameterName("Platform_id");
		...
		/// <summary>
		/// Deletes <c>Platform</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>Platform</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		{
			string sql = "DELETE FROM [dbo].[Platform]";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>Platform</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="PlatformRow"/> objects.</returns>
		protected PlatformRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="PlatformRow"/> objects.</returns>
		protected PlatformRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// the <c>Platform</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "Platform";
			DataColumn dataColumn;
	...
	} // End of PlatformCollection_Base class
}  // End of namespace
