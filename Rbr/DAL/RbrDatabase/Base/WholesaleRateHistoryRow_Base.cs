// <fileinfo name="Base\WholesaleRateHistoryRow_Base.cs">
//		<copyright>
...
{
	/// <summary>
	/// The base class for <see cref="WholesaleRateHistoryRow"/> that 
	/// represents a record in the <c>WholesaleRateHistory</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="WholesaleRateHistoryRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	[Serializable]
	public abstract class WholesaleRateHistoryRow_Base
	{
	#region Timok Custom
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="WholesaleRateHistoryRow_Base"/> class.
		/// </summary>
		public WholesaleRateHistoryRow_Base()
		{
			// EMPTY
		}
	...
	} // End of WholesaleRateHistoryRow_Base class
} // End of namespace
